                ...
                const inputTerminalHandler = (e) => {
                    if ('Enter' === e.key && e.target.value) {
                        ...
                        switch ((PREVIOUS_COMMANDS.push(input), input.split(' ')[0])) {
                            ...
                            case 'github':
                                let github;
                                window.open('https://github.com/hasancanbag', '_blank').focus(), (output = '');
                                break;
                            case 'https://kimlimjustin.com':
                            case 'kimlimjustin.com':
                            case 'http://kimlimjustin.com':
                                output =
                                    'This website is designed and built by Hasan Can Bağ using HTML, CSS and Vanilla JavaScript and was inspired by several websites over the internet. Find out the repo of this website <a href = "https://github.com/kimlimjustin/kimlimjustin.com" target="_blank" rel="noopener">here.</a>';
                                break;
                            case 'hello':
                            case 'hi':
                                window.open('mailto:kimlimjustin@gmail.com?Subject=Hello'),
                                    (output = 'Say hello to me <a href="mailto:hasancanbag@gmail.com?Subject=Hello">here!</a>');
                                break;
                            case 'refresh':
                            ...
                            case 'whoareu':
                            case 'whoareyou':
                                output = 'I\'m human :) Contact me <a href = "hasancanbag@gmail.com">here</a>';
                                break;
                            case 'clear':
