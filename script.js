...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (document.documentElement.clientWidth <= 480) {
        document.querySelector('.topnav-name').innerText = '<Hasan Can B./>';
    } else {
        document.querySelector('.topnav-name').innerText = '<Hasan Can Bağ />';
    }
    window.addEventListener('resize', () => {
        if (document.documentElement.clientWidth <= 480) {
            document.querySelector('.topnav-name').innerText = '<Hasan C. B. />';
        } else {
            document.querySelector('.topnav-name').innerText = '<Hasan Can Bağ />';
        }
    });
